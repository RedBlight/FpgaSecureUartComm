...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clock }];#set
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { modemOut }]; #IO_L19N_T3_VREF_13  Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { modemIn }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
...
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { txOut }]; #IO_L16P_T2_13       Sch=CK_IO34
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { rxIn }]; #IO_L22N_T3_13       Sch=CK_IO35
